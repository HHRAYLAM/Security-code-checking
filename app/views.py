...
from app.contract_interaction import upload_audit_record
from utils.network_utils import init_web3  # 导入网络切换工具
...
# 初始化 Web3 连接（可以选择 'local', 'sepolia', 'linea'）
web3 = init_web3(network='local')
...
def has_transferred(user_wallet_address):
    ...
    """
    min_transfer_amount = web3.toWei(0.001, 'ether')  # 设置最小转账金额
